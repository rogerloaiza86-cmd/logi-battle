...
export const StockCard = ({ 
  ...
  const getCategoryIcon = () => {
    switch(question?.category) {
      case 'Méthodes de gestion': return '📊'
      case 'Application FEFO': return '📅'
      case 'Adressage': return '📍'
      case 'Slotting': return '🎯'
      case 'Ergonomie': return '🧘'
      case 'Calcul stock': return '🧮'
      case 'Gestion des stocks': return '📦'
      case 'Inventaire': return '📝'
      case 'KPI': return '📈'
      case 'Classification': return '🏷️'
      case 'Organisation': return '🗂️'
