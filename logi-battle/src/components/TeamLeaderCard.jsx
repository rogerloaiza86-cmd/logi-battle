      ...
      >
        ...
        <div className="flex items-center gap-1 mt-3">
          ...
          {[...Array(3)].map((_, i) => (
            <span 
              key={i} 
              className={`text-xs ${i < question?.difficulty ? 'text-purple-400' : 'text-slate-700'}`}
            >
              ★
            </span>
          ))}
        ...
        {isAnswering && (
          ...
          >
            <div className="flex items-start gap-2">
              <span className={`material-icons ${accentColor} text-sm mt-0.5`}>psychology</span>
              <div>
                <p className="text-xs text-slate-400 uppercase tracking-wider mb-1">Analyse managériale</p>
