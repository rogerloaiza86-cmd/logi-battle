...
export const TraceabilityCard = ({ 
  ...
  const getCategoryIcon = () => {
    switch(question?.category) {
      ...
      case 'Chaîne du froid': return '🧊'
      case 'Rappel produit': return '🚨'
      case 'Dates': return '📅'
      case 'Codes': return '🔢'
      case 'Retours': return '↩️'
      case 'Crisis': return '🔥'
      case 'HACCP': return '📋'
      default: return '📡'
    }
        ...
        {isAnswering && (
          ...
          >
            <div className="flex items-start gap-2">
              <span className={`material-icons ${accentColor} text-sm mt-0.5`}>track_changes</span>
              <div>
                <p className="text-xs text-slate-400 uppercase tracking-wider mb-1">Traçabilité</p>
