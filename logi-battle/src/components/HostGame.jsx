...
export const HostGame = ({ onBack, gameMode }) => {
  ...
  useEffect(() => {
    const initGame = async () => {
      try {
        ...
        setInitError(err.message || 'Impossible de créer la partie.')
  ...
  const getPlayerUrl = () => {
    ...
    const url = new URL(`${basePath}join`, window.location.origin)
        ...
        <div className="max-w-4xl w-full grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="bg-white rounded-xl p-4 w-fit mx-auto mb-6">
              {isInitializing ? (
                ...
                <div className="w-48 h-48 flex items-center justify-center text-red-500 text-center text-sm px-4">
                  Partie non créée
                </div>
              )}
            </div>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={startGame}
              disabled={!gameId || initError || isInitializing}
