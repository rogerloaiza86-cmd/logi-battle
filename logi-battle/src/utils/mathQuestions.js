...
export const mathQuestions = [
  ...
  },
  {
    ...
    difficulty: 3,
    question: "Un camion de 13,60 m × 2,45 m × 2,70 m doit transporter des palettes 120×80 cm gerbées sur 2 niveaux. Combien de palettes maximum en théorie ?",
    options: ['26', '33', '52', '66'],
    correctOption: 3,
    explanation: "Longueur : 13,60 / 1,20 = 11 palettes. Largeur : 2,45 / 0,80 = 3 palettes. 11 × 3 = 33 palettes par niveau, soit 66 sur 2 niveaux.",
