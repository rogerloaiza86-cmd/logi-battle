...
function App() {
  ...
  const pathWithoutBase = basePath && currentPath.startsWith(basePath)
    ? currentPath.slice(basePath.length) || '/'
    : currentPath
  const isJoinRoute = pathWithoutBase === '/join' || currentPath.endsWith('/join') || window.location.search.includes('game=')
