...
-- Les clients anonymes peuvent créer/lire les parties et mettre à jour leur état,
-- mais ne peuvent pas supprimer les données ni modifier le référentiel de questions.
...
DROP POLICY IF EXISTS "Mise à jour publique limitée des parties" ON public.games;
...
WITH CHECK (true);
CREATE POLICY "Mise à jour publique limitée des parties"
...
DROP POLICY IF EXISTS "Création publique des questions" ON public.questions;
CREATE POLICY "Lecture publique des questions"
ON public.questions FOR SELECT
USING (true);
CREATE POLICY "Création publique des questions"
