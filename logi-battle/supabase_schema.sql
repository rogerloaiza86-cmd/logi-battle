...
-- Les questions contiennent "correctAnswer"; ne pas exposer cette table au rôle anonyme.
-- Seed/maintenance doivent passer par l'éditeur SQL Supabase ou une clé service côté serveur.
