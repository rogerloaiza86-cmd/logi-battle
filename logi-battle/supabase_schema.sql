...
-- Les parties live restent accessibles avec la clé publique, mais aucune policy
-- DELETE n'est créée afin d'éviter la perte de données via le client navigateur.
